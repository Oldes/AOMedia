...
enc: aom/make-encoder 640x480                        ;; initialize AV1 encoder
...
release :enc                                         ;; release the encoder
```
It is possible to initialize the encoder with optional configurations, such as:
```rebol
constrained-quality: [
    rc_end_usage:      2    ;= AOM_CQ
    rc_min_quantizer:  30
    rc_max_quantizer:  30
    rc_target_bitrate: 2000
]
enc: aom/make-encoder/with 640x480 :constrained-quality
```
